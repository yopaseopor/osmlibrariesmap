	...
	overlays: [
...

		{
			...
			style: function (feature) {
				...
				var name2 = feature.get(name_key2) || 'Accessibilitat';
			...
			
{
			...
			query: '(nwr["amenity"="library"]["changing_table:fee"="no"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			...
			
{
			...
			query: '(nwr["amenity"="library"]["changing_table:location"="wheelchair_toilet"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			...
			
{
			...
			query: '(nwr["amenity"="library"]["changing_table:location"="female_toilet"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			...
			
{
			...
			query: '(nwr["amenity"="library"]["changing_table:location"="male_toilet"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			...
			
{
			...
			query: '(nwr["amenity"="library"]["changing_table:location"="unisex_toilet"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			...
			
{
			...
			query: '(nwr["amenity"="library"]["changing_table:location"="dedicated_room"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 255, 165, 250 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			...
			query: '(nwr["amenity"="library"]["changing_table:location"="room"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			...
			
{
			group: 'Accés',
			title: 'Sí|Yes',
			query: '(nwr["amenity"="library"]["access"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 37, 180, 2  ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			group: 'Accés',
			title: 'No',
			query: '(nwr["amenity"="library"]["access"="no"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 202, 0, 0 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Accés',
			title: 'Designat/do|Designated',
			query: '(nwr["amenity"="library"]["access"="designated"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(243, 156, 18 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
		...
		
{
			group: 'Accés',
			title: 'Usuaris/os|Users',
			query: '(nwr["amenity"="library"]["access"="customers"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(52, 152, 219 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			group: 'Accés',
			title: 'Privats/dos|Private',
			query: '(nwr["amenity"="library"]["access"="private"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(125, 206, 160 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
		...
		
{
			group: 'Accés',
			title: 'Permissius/vos|Permissive',
			query: '(nwr["amenity"="library"]["access"="permissive"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 255, 165, 250 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
 ...
 },
 {
			...
			title: 'Aire acondicionat/do|Air conditioning',
			query: '(nwr["amenity"="library"]["air_conditioning"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 37, 180, 2  ,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Serveis|Servicios|Services',
			title: 'NO Aire acondicionat/do|NO Air conditioning',
			query: '(nwr["amenity"="library"]["air_conditioning"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 202, 0, 0 ,1)',
			style: function (feature) {
		...
		
{
 ...
 {
			group: 'Pagar|Payment',
			title: 'NO Targeta crèdit<br>NO Tarjeta crédito<br>NO Credit card',
			query: '(nwr["amenity"="library"]["payment:credit_cards"no"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 37, 180, 2  ,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Pagar|Payment',
			title: 'Targeta crèdit<br>Tarjeta crédito<br>Credit card',
			query: '(nwr["amenity"="library"]["payment:credit_cards"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 186, 74, 0 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Pagar|Payment',
			title: 'NO Metàl·lic|NO Metálico|NO Cash',
			query: '(nwr["amenity"="library"]["payment:cash"="no"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(223, 255, 0,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Pagar|Payment',
			title: 'Metàl·lic|Metálico|Cash',
			query: '(nwr["amenity"="library"]["payment:cash"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(204, 204, 255,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Pagar|Payment',
			title: 'De pagament<br>De pago<br>Fee',
			query: '(nwr["amenity"="library"]["fee"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 186, 74, 0 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Pagar|Payment',
			title: 'Gratuïta<br>No fee',
			query: '(nwr["amenity"="library"]["fee"="no"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(223, 255, 0,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Accés/o a Internet |access',
			title: 'Sí|Yes',
			query: '(nwr["amenity"="library"]["internet_access"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 37, 180, 2  ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			group: 'Accés/o a Internet |access',
			title: 'No',
			query: '(nwr["amenity"="library"]["internet_access"="no"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 202, 0, 0 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			group: 'Accés/o a Internet |access',
			title: 'Terminal',
			query: '(nwr["amenity"="library"]["internet_access"="terminal"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(243, 156, 18 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			group: 'Accés/o a Internet |access',
			title: 'WIFI',
			query: '(nwr["amenity"="library"]["internet_access"="wifi"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(52, 152, 219 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			group: 'Accés/o a Internet |access',
			title: 'Cable|Wired',
			query: '(nwr["amenity"="library"]["internet_access"="wired"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(125, 206, 160 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			...
			query: '(nwr["amenity"="library"]["internet_access:fee"="customers"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 255, 165, 250 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
			...
			
{
			group: 'Accés/o a Internet |access',
			title: 'Gratis|Free',
			query: '(nwr["amenity"="library"]["internet_access:fee"="free"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba( 186, 74, 0 ,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Accés/o a Internet |access',
			title: 'Pagament|De pago|Fee yes',
			query: '(nwrc["internet_access:fee"="yes"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(223, 255, 0,1)',
			style: function (feature) {
				var key_regex = /^name$/
...
{
			group: 'Accés/o a Internet |access',
			title: 'No de pagament|No fee',
			query: '(nwr["amenity"="library"]["internet_access:fee"="no"]({{bbox}});node(w););out meta;',
			iconSrc: imgSrc + 'base/circle.svg',
			iconStyle: 'background-color:rgba(204, 204, 255,1)',
			style: function (feature) {
				var key_regex = /^name$/
