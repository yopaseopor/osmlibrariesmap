...
$(function () {
	...
	map.addControl(new ol.control.Control({
		...
		var container = $('<div>Text').addClass('ol-control ol-unselectable osmcat-infobutton2').html($('Text2<button type="button"><i class="fa fa-search-plus"></i></button>').on('click', function () {
			window.location.href = 'https://github.com/yopaseopor/osmlibrarymap';
		}));
		return container[0];
	};
